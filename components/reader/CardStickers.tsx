...
export function CardSticker({ index, className }: CardStickerProps) {
  ...
  return (
    <span
      className={`pointer-events-none absolute -right-1 -top-2 size-11 ${className ?? ""}`}
  ...
  return (
    <svg viewBox="0 0 40 40" className="size-full" fill="none">
      <g fill="#FFF8F1" stroke="#7A9E6D" strokeWidth="1.3" strokeLinejoin="round">
        ...
        <ellipse cx="12.5" cy="12.5" rx="4.5" ry="6" transform="rotate(-45 12.5 12.5)" />
        <ellipse cx="27.5" cy="12.5" rx="4.5" ry="6" transform="rotate(45 27.5 12.5)" />
      </g>
      <circle cx="20" cy="20" r="4.5" fill="#F0D78C" stroke="#7A7468" strokeWidth="1.2" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 40 40" className="size-full" fill="none">
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="29" cy="13" r="4" fill="#E07A7A" />
    </svg>
  );
}
